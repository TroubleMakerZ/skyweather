...
import com.zxx.skyweather.databinding.SimpleItemBinding

class ChoosePlaceAdapter(context: Context, private val resId: Int, private val dataList: List<String>) : ArrayAdapter<String>(context, resId, dataList) {
