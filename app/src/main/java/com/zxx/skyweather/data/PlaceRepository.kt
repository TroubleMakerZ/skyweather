 ...
 *
 */
import com.zxx.skyweather.data.db.PlaceDao
import com.zxx.skyweather.data.network.SkyWeatherNetwork
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.withContext

class PlaceRepository private constructor(private val placeDao: PlaceDao, private val network: SkyWeatherNetwork) {
    ...
    companion object {
        ...
        fun getInstance(placeDao: PlaceDao, network: SkyWeatherNetwork): PlaceRepository {
            if (instance == null) {
